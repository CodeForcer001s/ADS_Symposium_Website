          ...
          <div className="mt-16 space-y-10">
            ...
            >
              <motion.div
                ...
                className="about-paragraph-wrapper text-left text-lg md:text-xl leading-relaxed"
                whileHover={{
                  scale: 1.02,
                ...
                onMouseMove={handleMouseMove}
              >
                <p className="about-paragraph about-paragraph-blue">
                  Our technical symposium brought together bright minds for five
                  distinct competitive events spanning software development,
                  data analytics, and cybersecurity. Participants showcased
                  their technical prowess in rigorous challenges, pushing the
                  boundaries of innovation and creative problem-solving in a
            ...
            >
              <motion.div
                ...
                onMouseMove={handleMouseMove}
              >
                <p className="about-paragraph about-paragraph-purple">
                  The AI & Data Science department is a hub for cutting-edge
                  research and education. Through hands-on projects and industry
                  collaboration, our students and faculty drive impactful
                  advancements, preparing for careers at the forefront of
                  technology and addressing real-world challenges.
                </p>
