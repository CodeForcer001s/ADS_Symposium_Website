...
const FuturisticEventHero = ({ event }) => {
    ...
    return (
        <div
            ...
            style={{ background: "radial-gradient(ellipse at center, #001122 0%, #000511 100%)" }}
        >
            ...
            <div className="container mx-auto px-4 py-24 relative z-30">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 animate-fade-in-up [animation-delay:0.8s]">
                        <a href="#register" className="group px-10 py-4 cyber-button rounded-lg text-white font-bold text-lg transform hover:scale-105 transition-all duration-300 relative z-10">
                            <span className="flex items-center gap-3 relative z-10">
                                REGISTER NOW
                                <svg className="w-5 h-5 group-hover:translate-x-2 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg>
                            </span>
                        </a>
                        <a href="#about" className="group px-10 py-4 outline-button rounded-lg text-cyan-400 font-bold text-lg hover:text-white transform hover:scale-105 transition-all duration-300 flex items-center gap-3">
                            LEARN MORE
                        </a>
                    </div>
                </div>
